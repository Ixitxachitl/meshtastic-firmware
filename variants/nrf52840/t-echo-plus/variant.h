...
#ifndef _VARIANT_TTGO_EINK_V1_0_PLUS_
#define _VARIANT_TTGO_EINK_V1_0_PLUS_
...
#define PIN_BUTTON_TOUCH (0 + 11) // 0.11 is the soft touch button on T-Echo Plus
 ...
 * Analog pins
 */
#define PIN_A0 (4) // Battery ADC - P0.04 on T-Echo Plus
...
// T-Echo Plus: BHI260AP IMU and Grove Port share I2C bus
#define PIN_WIRE_SDA (26) // P0.26 - I2C SDA (BHI260AP IMU + Grove Port)
#define PIN_WIRE_SCL (27) // P0.27 - I2C SCL (BHI260AP IMU + Grove Port)

/* touch sensor, active high */

#define TP_SER_IO (0 + 11)

#define PIN_RTC_INT (0 + 16) // P0.16 - Interrupt from the RTC

// T-Echo Plus specific pins
#define PIN_BUZZER (0 + 6)       // P0.06 - Buzzer (DRV2605)
#define PIN_VIBRATION_EN (0 + 8) // P0.08 - Vibration Motor Enable (DRV2605_ENABLE_PIN)
...
#define PIN_POWER_EN (0 + 12) // P0.12 - POWER_EN on T-Echo Plus
...
// Battery
// The battery sense is hooked to pin A0 (P0.04) on T-Echo Plus
