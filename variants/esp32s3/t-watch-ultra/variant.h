...
// Custom boot splash, shown for the second half of the boot screen: 410x502 artwork, the panel's own
// size, drawn in colour on colour-framebuffer builds. 1:1 scale - BASEUI_ICON_SCALE would double it off.
