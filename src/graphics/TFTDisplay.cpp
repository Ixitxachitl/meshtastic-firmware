...
bool TFTDisplay::connect()
{
    ...
    if (this->linePixelBuffer == NULL) {
        ...
        memaudit::add("display", sizeof(uint16_t) * linePixels, this->linePixelBuffer);
    }
    if (this->repaintChunkBuffer == NULL) {
        ...
        allBuffersDmaCapable &= thisBufferDmaCapable;
        memaudit::add("display", sizeof(uint16_t) * chunkPixels * this->chunkBufferSlots, this->repaintChunkBuffer);
    }
#if BASEUI_NATIVE_RGB565
    {
