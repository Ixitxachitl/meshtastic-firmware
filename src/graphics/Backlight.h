...
// PWM_BACKLIGHT_ACTIVE_LOW inverts the duty, for a rail wired the other way up.
// TFT_BACKLIGHT_AFTER_FIRST_FRAME leaves the rail dark at init so TFTDisplay::connect() can light
// it once the panel's GRAM has been cleared.
