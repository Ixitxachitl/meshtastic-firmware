...
// === BEGIN RGB565 EMOTES (generated by the RGB565 Image Editor; re-export rather than editing) ===
...
namespace graphics
{
// The colour version of an emote bitmap, or nullptr to keep drawing the 1-bit original.
