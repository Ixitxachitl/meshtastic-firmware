...
#define NONBLOCKINGRTTTL_VERSION 1.4.0
...
/****************************************************************************
 * Description:
 *   isPlaying() returns true if a song is still playing.
...
/****************************************************************************
 * Description:
 *   done() returns true when the player is done playing the current song.
 *   Note that if the song is played in loop indefinetely, done() will never
 *   return true.
 ****************************************************************************/
bool done();
