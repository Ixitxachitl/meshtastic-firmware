...
class AudioThread : public concurrency::OSThread
{
  public:
    ...
    {
#if defined(ARDUINO_ARCH_ESP32)
        // Stop the task here rather than relying on ~OSThread(): by the time the
        // base destructor runs, the derived half of the object - including the
        // runOnce() the task may still be inside - is already gone.
        stopFreeRTOSTask();
#endif
